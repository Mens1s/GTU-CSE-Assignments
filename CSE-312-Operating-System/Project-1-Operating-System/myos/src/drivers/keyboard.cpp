...
void KeyboardEventHandler::OnKeyDownInt(uint8_t key)
{
    Buffer *b = new Buffer();
    b->Write(key); // buffera kayit ediyorum ::TODO type ya da gelis
}   
...
uint32_t KeyboardDriver::HandleInterrupt(uint32_t esp)
{
    ...
    if(key < 0x80)
    {
        switch(key)
        {
            case 0x02: handler->OnKeyDownInt(1); break;
            case 0x03: handler->OnKeyDownInt(2); break;
            case 0x04: handler->OnKeyDownInt(3); break;
            case 0x05: handler->OnKeyDownInt(4); break;
            case 0x06: handler->OnKeyDownInt(5); break;
            case 0x07: handler->OnKeyDownInt(6); break;
            case 0x08: handler->OnKeyDownInt(7); break;
            case 0x09: handler->OnKeyDownInt(8); break;
            case 0x0A: handler->OnKeyDownInt(9); break;
            case 0x0B: handler->OnKeyDownInt(0); break;
            ...
            case 0x1C: b->setDone(true); break;
