...
public class Account {
    ...
    private LinkedList<String> blockedList;
    /**
    ...
    public Account(int accountId, String username, String birthdate, String location, LinkedList<Account> accounts) throws Exception {
     ...
     * */
    public int blockUsername(LinkedList<Account> accounts, String blockedUsername){

        boolean flag = false;
        for(Account account : accounts){
            if( account.username == blockedUsername) {
                // delete from following - followers list of blocked account
                account.unfollowPrivate(accounts, getUsername());
     ...
     * @return INT -1 no account find with given username, 1 blocked successfully
     * */
    public int unBlockUsername(LinkedList<Account> accounts, String blockedUsername){
     ...
     * */
    private void unfollowPrivate(LinkedList<Account> accounts, String user){
     ...
     * @param user STRING username that will be deleted from following list
     * */
    public void unfollow(LinkedList<Account> accounts, String user){
        if(!isLogin()) {
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void viewProfile(LinkedList<Account> accounts, String viewedProfileUsername){
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void viewPosts(LinkedList<Account> accounts){
        if(!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void viewPostsInteractions(LinkedList<Account> accounts){
        if(!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * */
    public void follow(LinkedList<Account> accounts, String username){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * */
    public void sendMessage(LinkedList<Account> accounts,String receiverUsername, String content){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void showInbox(LinkedList<Account> accounts){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * */
    public void showInbox(LinkedList<Account> accounts, String username){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void showOutbox(LinkedList<Account> accounts){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * */
    public void sharePost(LinkedList<Account> accounts, String content){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
     ...
     * */
    public void likePost(LinkedList<Account> accounts, int postID){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param postID ID content of post
     * */
    public void unlikePost(LinkedList<Account> accounts, int postID){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void unlikePosts(LinkedList<Account> accounts, String unlikedUser){
     ...
     * */
    public void commentPost(LinkedList<Account> accounts, int postID, String content){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param postID ID content of post
     * */
    public void uncommentPost(LinkedList<Account> accounts, int postID){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void uncommentPosts(LinkedList<Account> accounts, String uncommentedUser){
    ...
    public void setBlockedList(LinkedList<String> blockedList) {
