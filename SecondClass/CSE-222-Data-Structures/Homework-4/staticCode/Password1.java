...
public class Password1 {
    ...
    private static String password1Cleaned = "";
    /**
     * String that holds only brackets */
    private static String password1Brackets = "";
    /**
    ...
    private static void cleanPassword1(String password1) {
    ...
    private static boolean containsUserNameSpirit(String username) {
    ...
    private static boolean isBalancedPassword() {
    ...
    private static boolean containsOnlyLetter() {
    ...
    private static boolean isPalindromePossible(String password1, int oddCount){
    ...
    public static boolean checkPassword1(String username, String password1){
