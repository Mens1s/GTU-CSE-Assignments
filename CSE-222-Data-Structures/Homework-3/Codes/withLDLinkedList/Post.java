...
public class Post {
    ...
    * */
    ...
    private void showLikes(LDLinkedList<Account> accounts) {
        if( getLikeCount() == 0)
    ...
    private void showComments(LDLinkedList<Account>accounts) {
    ...
    public void showInteractions(LDLinkedList<Account> accounts) {
        showLikes(accounts);
