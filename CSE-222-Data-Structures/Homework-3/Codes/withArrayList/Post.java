...
public class Post {
    ...
    * */
    ...
    private void showLikes(ArrayList<Account> accounts) {
        if( getLikeCount() == 0)
    ...
    private void showComments(ArrayList<Account>accounts) {
    ...
    public void showInteractions(ArrayList<Account> accounts) {
        showLikes(accounts);
