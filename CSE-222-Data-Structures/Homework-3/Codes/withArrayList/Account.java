...
public class Account {
    ...
    public Account(int accountId, String username, String birthdate, String location, ArrayList<Account> accounts) throws Exception {
     ...
     * */
    public int blockUsername(ArrayList<Account> accounts, String blockedUsername){
     ...
     * @return INT -1 no account find with given username, 1 blocked successfully
     * */
    public int unBlockUsername(ArrayList<Account> accounts, String blockedUsername){
     ...
     * */
    private void unfollowPrivate(ArrayList<Account> accounts, String user){
     ...
     * @param user STRING username that will be deleted from following list
     * */
    public void unfollow(ArrayList<Account> accounts, String user){
        if(!isLogin()) {
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void viewProfile(ArrayList<Account> accounts, String viewedProfileUsername){
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void viewPosts(ArrayList<Account> accounts){
        if(!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void viewPostsInteractions(ArrayList<Account> accounts){
        if(!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * */
    public void follow(ArrayList<Account> accounts, String username){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * */
    public void sendMessage(ArrayList<Account> accounts,String receiverUsername, String content){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void showInbox(ArrayList<Account> accounts){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * */
    public void showInbox(ArrayList<Account> accounts, String username){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void showOutbox(ArrayList<Account> accounts){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
            return;
        }
    ...
    private String idtoUsername(ArrayList<Account> accounts, int id) {
        for (Account account : accounts) {
            if (account == null)
                break;
     ...
     * */
    public void sharePost(ArrayList<Account> accounts, String content){
        if ( !isLogin() ) {
            System.out.println("You have to login!");
     ...
     * */
    public void likePost(ArrayList<Account> accounts, int postID){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param postID ID content of post
     * */
    public void unlikePost(ArrayList<Account> accounts, int postID){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void unlikePosts(ArrayList<Account> accounts, String unlikedUser){
     ...
     * */
    public void commentPost(ArrayList<Account> accounts, int postID, String content){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param postID ID content of post
     * */
    public void uncommentPost(ArrayList<Account> accounts, int postID){
        if (!isLogin()) {
            System.out.println("You have to login!");
            return;
        }
     ...
     * @param accounts ACCOUNT ARRAY which holds all created account objects.
     * */
    public void uncommentPosts(ArrayList<Account> accounts, String uncommentedUser){
